package com.cf.bishanpatent.config;
...
@ComponentScan("com.cf.bishanpatent.controller")
public class SwaggerConfig {  //随便的一个类名
    ...
    public Docket docker(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //apis： 添加过滤条件,
                .apis(RequestHandlerSelectors.basePackage("com.lqh.beibeipatent.controller"))
